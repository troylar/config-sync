"""OpenRouter provider using HTTP-only calls (OpenAI-compatible API)."""
...
class OpenRouterProvider(LLMProvider):
    ...
    Uses httpx for HTTP calls — no SDK dependency.
    """
    ...
    def complete(
        ...
        *,
        ...
        headers = {
            ...
            "HTTP-Referer": "https://github.com/troylar/devsync",
            "X-Title": "DevSync",
        }
        ...
        try:
            ...
            raise LLMProviderError(f"HTTP error calling OpenRouter API: {e}") from e
